export default [
    {
        id: 0,
        name: 'WatchLiq',
        brief: 'ERC20 token that powers watch liquidity lending for watch-backed nfts built by watches.io ERC20 token that powers watch liquidity lending for watch-backed nfts built by watches.ioERC20 token that powers watch liquidity lending for watch-backed nfts built by watches.ioERC20 token that powers watch liquidity lending for watch-backed nfts built by watches.io',        
        cardImage: '/images/projects/10k.jpeg',
        bgImage: '/images/projects/10k.jpeg',
        startDate: 'FEB 2,2024',
        endDate: 'FEB 2,2024',
        projectIds: [1,2],
        details: `Introducing WatchLiQ Token (WATCH), the revolutionary ERC-20 token designed to redefine the landscape of watch-based Non-Fungible Tokens (NFTs) by fueling lending protocols tailored specifically for these unique digital assets. WatchLiQ Token is your top choice for your hackathon submission, offering an innovative solution that paves the way for new opportunities for NFT enthusiasts and collectors, empowering them to maximize the utility of their treasured timepiece-based digital assets.
