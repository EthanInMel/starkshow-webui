...
export default function Home() {
  return (
    <>
      <section className="flex flex-col items-center justify-center gap-4 w-f md:h-[85vh] relative">
        <Image
          alt="nextui logo"
          ...
          className="w-full"
        />
        <div className="inline-block text-center justify-center absolute bottom-[55px]">
          <span className="text-9xl ">
            Make <span className="text-blue-500">Starknet</span> great.
          </span>
          <br />
